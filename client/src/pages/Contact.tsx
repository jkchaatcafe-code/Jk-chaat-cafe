...
export default function Contact() {
  ...
  return (
    <>
      <SEO
        title="Contact JK Chaat Cafe – Franchise & Business Enquiries India"
        description="Contact JK Chaat Cafe for franchise opportunities, business enquiries, menu information and partnership details. Connect with our team for your next food business."
        canonical="https://jkchaatcafe.com/contact"
        keywords="JK Chaat Cafe contact, JK Chaat Cafe franchise contact, chaat franchise enquiry, food franchise enquiry India, food business enquiry"
