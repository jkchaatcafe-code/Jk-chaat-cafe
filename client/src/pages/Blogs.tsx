...
const getCoverImage = (blog: Blog, index: number) => {
  if (blog.coverImage) {
    // ✅ Agar full URL hai toh direct use karo
    if (blog.coverImage.startsWith('http')) {
      return blog.coverImage;
    }
    // ✅ Uploaded image ke liye API base use karo
  ...
  return (
    <>
      <SEO
        title="JK Chaat Cafe Blog – Food, Chaat & Franchise Business Insights"
        description="Read JK Chaat Cafe blogs covering Indian street food, chaat, fast food, cafe business, food franchise opportunities and useful insights for entrepreneurs."
        canonical="https://jkchaatcafe.com/blogs"
        keywords="food franchise blog India, Indian street food blog, chaat blog India, food franchise India, food business India, street food business, QSR business India"
