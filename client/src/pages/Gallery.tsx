...
export default function Gallery() {
  ...
  return (
    <>
      <SEO
        title="JK Chaat Cafe Gallery – Food, Cafe & Franchise Outlet Photos"
        description="View JK Chaat Cafe photos featuring delicious food, chaat, fast food, beverages, cafe interiors and franchise outlet designs from the JK Chaat Cafe brand."
        canonical="https://jkchaatcafe.com/gallery"
        keywords="JK Chaat Cafe gallery, JK Chaat Cafe photos, chaat cafe photos, Indian street food photos, food franchise outlet"
