...
import { organizationSchema, breadcrumbSchema, faqSchema } from '../utils/schema'
...
export default function Franchise() {
  const faqs = [
    {
      question: "What is JK Chaat Cafe franchise?",
      answer: "JK Chaat Cafe franchise is a comprehensive food business opportunity offering authentic Indian chaat, fast food, and beverages with complete brand support including kitchen setup, spices, staff training, and marketing assistance."
    },
    {
      question: "How can I start a JK Chaat Cafe franchise?",
      answer: "To start a JK Chaat Cafe franchise, contact us through the franchise enquiry form or call us directly. Our team will guide you through the entire process from store setup to operations."
    },
    {
      question: "What support does JK Chaat Cafe provide?",
      answer: "JK Chaat Cafe provides complete kitchen setup support, authentic spice and recipe training, staff training, brand marketing support, and ongoing operational guidance."
    },
    {
      question: "Where can I open a JK Chaat Cafe franchise?",
      answer: "JK Chaat Cafe franchise opportunities are available across India. Contact us to check availability in your preferred location."
    },
    {
      question: "How can I contact JK Chaat Cafe for franchise information?",
      answer: "You can contact JK Chaat Cafe through the franchise enquiry form on this page, call us at +91-XXXXXXXXXX, or email us at franchise@jkchaatcafe.com."
    }
  ]

  const breadcrumbItems = [
    { name: 'Home', url: 'https://jkchaatcafe.com/' },
    { name: 'Franchise', url: 'https://jkchaatcafe.com/franchise' }
  ]

  // Popup related code removed - ab hum popup use nahi karenge
  // Sirf redirect karenge /franchise-application pe

  return (
    <>
      <SEO
        title="Chaat Franchise in India – JK Chaat Cafe Franchise Opportunity"
        description="Start your own JK Chaat Cafe franchise in India with brand support, kitchen setup, spices, staff guidance and store setup. Explore our food franchise opportunity today."
        canonical="https://jkchaatcafe.com/franchise"
        keywords="chaat franchise in India, chaat franchise, chaat franchise opportunity, best chaat franchise in India, food franchise in India, food franchise opportunity, street food franchise India, QSR franchise India, JK Chaat Cafe franchise"
        schema={[organizationSchema, breadcrumbSchema(breadcrumbItems), faqSchema(faqs)]}
      />
      ...
      <div className="jk-franchise-v2">
        ...
        <section className="fr-hero">
          ...
          <div className="container fr-hero-content">
            ...
            >
              <Link to="/franchise-application" className="btn-hero">
                Get Franchise Now
        ...
        <section className="section" style={{ paddingTop: 0 }}>
          <div className="container pkg-grid">
            <Reveal className="pkg-card">
              ...
              {/* === CHANGE: Link to /franchise-application === */}
              <Link to="/franchise-application" className="btn-ghost">Apply for Starter</Link>
            </Reveal>
            <Reveal delay={0.08} className="pkg-card featured">
              ...
              {/* === CHANGE: Link to /franchise-application === */}
              <Link to="/franchise-application" className="btn-ghost">Apply for Complete Cafe</Link>
            </Reveal>
            <Reveal delay={0.16} className="pkg-card">
              ...
              {/* === CHANGE: Link to /franchise-application === */}
              <Link to="/franchise-application" className="btn-ghost">Enquire for Master Franchise</Link>
            </Reveal>
          </div>
        </section>
          ...
          <div className="container">
            <div className="fr-cta-banner">
              ...
              <div className="fr-cta-content">
                ...
                {/* === CHANGE: Link to /franchise-application === */}
                <Link to="/franchise-application" className="btn-primary-cta">
